package net.chixozhmix.chilib.world.structures;
...
// Простая структура для регистрации в коде. Расширяйте ее для всех структур. Сделана во избежания дублирования кода
public abstract class BaseJigsawStructure extends Structure {
    ...
    protected BaseJigsawStructure(StructureSettings settings, Holder<StructureTemplatePool> startPool,
    ...
    protected static <T extends BaseJigsawStructure> Codec<T> createCodec(StructureFactory<T> factory) {
    ...
    public interface StructureFactory<T extends BaseJigsawStructure> {
        ...
        T create(StructureSettings settings, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName,

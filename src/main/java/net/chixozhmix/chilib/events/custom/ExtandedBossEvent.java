package net.chixozhmix.chilib.events.custom;
...
/**
 * Евент для босса. Через него лучше задавать кастомный боссбар. Можно также задать видимость тумана и подобного
 */
public class ExtandedBossEvent extends BossEvent {
    private final Set<ServerPlayer> players = Sets.newHashSet();
    private final Set<ServerPlayer> unmodifiablePlayers = Collections.unmodifiableSet(this.players);
    private boolean visible = true;

    public ExtandedBossEvent(UUID pId, Component pName, BossBarColor pColor, BossBarOverlay pOverlay) {
